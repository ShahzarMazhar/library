...
//     );
//     addAttribute('data-id', [card, _book.id]);


//     book.style.backgroundColor = _book.color;
//     title.textContent = _book.title;
//     author.textContent = _book.author;
//     p.textContent = _book.readStatus;
...
function addEvent(item) {
  ...
  item.addEventListener('mouseleave', (e) => $('ul', e.target).remove());
  $('span', item).addEventListener('click', openEditBook);
}
